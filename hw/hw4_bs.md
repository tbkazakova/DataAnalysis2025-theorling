...
2. Write code that takes at least 20 the links from the main page(s) and than get their titles and texts with the code from the previous step. (3 points)
...
5. Translate the texts into English using a ready-made library. Save the translations in a separate column. (2 points)
...
```
6. Create a word cloud from all the texts you collected. (1 point)
